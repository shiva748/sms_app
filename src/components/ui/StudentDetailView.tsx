        ...
        <div className="flex flex-col sm:flex-row gap-6 items-center sm:items-start mb-8">
            ...
            <div className="flex-1 space-y-2 pt-2 text-center sm:text-left w-full">
                <div>
                    ...
                    <p className="text-sm text-slate-500 font-medium">Admission No: <span className="text-slate-700">{student.admissionNumber}</span></p>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm font-semibold text-slate-800">Indian</p>
                        </div>
                    </div>
                </div>
            </div>
